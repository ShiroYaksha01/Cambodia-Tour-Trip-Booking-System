<template>
  <div
    class="min-h-screen bg-[#fcfcfb] py-12 px-4 sm:px-6 lg:px-8 font-sans text-[#142125]"
  >
    <div class="max-w-4xl mx-auto">
      ...
      <nav class="flex items-center justify-center gap-4 mb-12">
        <div class="flex items-center gap-2">
          <div
            class="w-8 h-8 rounded-full bg-[#0e7f76] text-white flex items-center justify-center text-xs font-bold shadow-lg shadow-[#0e7f76]/20"
          >
            1
          </div>
          <span
            class="text-xs font-bold text-[#142125] uppercase tracking-widest"
            >Details</span
          >
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        <!-- Summary Side -->
        <div
          class="bg-[#142125] rounded-3xl p-10 text-white shadow-2xl relative overflow-hidden order-2 lg:order-1"
        >
          <div
            class="absolute top-0 right-0 w-64 h-64 bg-[radial-gradient(circle_at_top_right,rgba(244,167,29,0.15),transparent_70%)]"
          ></div>

          <div class="relative z-10">
            <span
              class="text-[#f4a71d] text-[0.65rem] font-bold tracking-[0.3em] uppercase block mb-4"
              >Your Selection</span
            >
            <h2 class="text-3xl font-extrabold mb-8 leading-tight">
              {{ service?.title || "Heritage Experience" }}
            </h2>
            ...
            <div
              class="bg-white/5 rounded-2xl p-6 backdrop-blur-sm border border-white/10"
            >
              <div class="flex justify-between items-baseline">
                <span
                  class="text-sm font-bold text-[#f4a71d] uppercase tracking-widest"
            ...
            <p class="mt-8 text-xs text-white/40 italic leading-relaxed">
              * Final amount includes all curated access fees and private guide
              credentials. No hidden supplements.
            </p>
          </div>
        </div>
        ...
        <div class="order-1 lg:order-2">
          <div class="mb-10">
            <h1
              class="text-4xl font-extrabold text-[#1d2427] tracking-tight mb-3"
            >
              Finalize Journey
            </h1>
            <p class="text-[#69757a] text-[1rem] leading-relaxed">
              Configure your exploration schedule and guest credentials.
            </p>
          </div>
          ...
          <form @submit.prevent="submitBooking" class="space-y-8">
            ...
            <div class="space-y-3">
              <label
                class="text-[0.75rem] font-bold text-[#8b9498] uppercase tracking-[0.15em] ml-1"
                >Preferred Date</label
              >
              <div class="relative group">
                <div
                  class="absolute inset-y-0 left-4 flex items-center pointer-events-none text-[#0e7f76]"
                >
                  <svg
                    class="w-5 h-5"
                    fill="none"
              ...
              <p v-if="errors.date" class="text-red-500 text-xs font-bold ml-1">
                {{ errors.date }}
              </p>
            </div>
            ...
            <div
              v-if="apiError"
              class="bg-red-50 border border-red-100 rounded-2xl p-4 flex gap-3 items-center"
            >
              <span
          ...
          <footer
            class="mt-12 text-center text-[#8d9497] text-[0.6rem] font-bold tracking-widest uppercase"
          >
