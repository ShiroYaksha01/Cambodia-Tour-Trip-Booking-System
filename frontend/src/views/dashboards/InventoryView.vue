...
.brand-mark { width: 34px; height: 34px; border-radius: 10px; display: grid; place-items: center; background: #0f7c7f; color: #fff; font-size: 18px; }
.sidebar-brand h1 { margin: 0; font-size: 16px; font-weight: 700; }
.sidebar-brand p { margin: 2px 0 0; font-size: 11px; color: #9ca7ae; letter-spacing: 0.08em; }
...
.new-booking-btn { margin-top: auto; border: 0; border-radius: 8px; padding: 12px 14px; background: #0f7c7f; color: #fff; font-weight: 700; box-shadow: 0 10px 20px rgba(15, 124, 127, 0.25); }
...
.topbar-title { font-size: 18px; font-weight: 700; color: #26444b; }
.topbar-actions { display: flex; align-items: center; gap: 10px; }
.unsaved-badge { font-size: 11px; color: #c33a31; font-weight: 600; }
.save-btn { border: 0; border-radius: 6px; padding: 6px 14px; background: #0f7c7f; color: #fff; font-size: 12px; font-weight: 700; cursor: pointer; }
.sync-pill { display: inline-flex; align-items: center; gap: 8px; padding: 4px 10px; border-radius: 999px; background: #f1f3f2; color: #6a757d; font-size: 11px; }
...
.metric-card p { margin: 0; font-size: 11px; letter-spacing: 0.06em; color: #7c8a92; font-weight: 700; }
.metric-card h3 { margin: 8px 0 4px; font-size: 28px; line-height: 1; }
.metric-card span { font-size: 12px; color: #7d8a91; }
...
.icon-btn { border: 0; background: transparent; color: #4f666f; cursor: pointer; font-size: 18px; }
.view-toggle { display: flex; gap: 6px; }
.view-toggle button { border: 0; background: #edf0ee; color: #4f666f; border-radius: 6px; padding: 6px 12px; font-size: 12px; font-weight: 700; }
.view-toggle button.active { background: #0f7c7f; color: #fff; }
.date-picker-input { border: 1px solid #e6eae7; background: #f9fbfa; border-radius: 6px; padding: 6px 10px; font-size: 13px; color: #20313a; cursor: pointer; font-family: inherit; }
...
.inventory-head { padding: 12px 16px; color: #75838b; font-size: 11px; font-weight: 700; letter-spacing: 0.1em; border-bottom: 1px solid #eef1f0; }
...
.item-info p { margin: 4px 0 0; color: #77848c; font-size: 11px; }
...
.day-date-label { font-size: 10px; color: #5d6e76; font-weight: 600; margin-bottom: 1px; }
.day-cell strong { font-size: 12px; line-height: 1.05; }
.day-cell span { font-size: 11px; color: #7d8b92; margin-top: 4px; }
...
.cell-input { width: 100%; border: 1px solid #0f7c7f; background: white; border-radius: 4px; padding: 3px 6px; font-size: 11px; text-align: center; outline: none; }
.cell-actions { display: flex; gap: 2px; margin-top: 2px; }
.cell-save, .cell-cancel { border: 0; border-radius: 3px; padding: 1px 5px; font-size: 10px; cursor: pointer; line-height: 1.2; }
.cell-save { background: #0f7c7f; color: white; }
.cell-cancel { background: #e8ebea; color: #4f666f; }
.legend-row { display: flex; align-items: center; gap: 18px; padding: 12px 2px 0; color: #5d6e76; font-size: 12px; }
.legend-row > div { display: inline-flex; align-items: center; gap: 8px; }
.legend-row a { margin-left: auto; color: #0f7c7f; text-decoration: none; font-weight: 700; }
...
.field-group label { font-size: 11px; color: #75838b; text-transform: uppercase; letter-spacing: 0.05em; font-weight: 700; }
...
.primary-action, .secondary-action { width: 100%; border: 1px solid transparent; border-radius: 6px; padding: 10px 12px; font-weight: 700; cursor: pointer; }
...
.notice-box strong { display: block; color: #9d6a10; font-size: 13px; }
.notice-box p { margin: 4px 0 0; color: #7b6b4b; font-size: 12px; }
.two-col { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
.changes-list { list-style: none; margin: 0; padding: 0; display: grid; gap: 10px; color: #30424b; font-size: 13px; }
...
.floating-save { position: fixed; right: 20px; bottom: 18px; width: 44px; height: 44px; border: 0; border-radius: 12px; background: #0f7c7f; color: #fff; font-size: 18px; box-shadow: 0 14px 28px rgba(15, 124, 127, 0.3); cursor: pointer; z-index: 20; }
...
.drawer-header h3 { margin: 4px 0 0; font-size: 18px; }
...
.drawer-field label { font-size: 11px; color: #7b8a91; font-weight: 600; }
.drawer-field input, .drawer-field select { border: 1px solid #e6eae7; background: white; border-radius: 6px; padding: 6px 10px; font-size: 13px; color: #20313a; width: 100%; }
.drawer-footer { display: flex; gap: 10px; margin-top: 20px; padding-top: 16px; border-top: 1px solid #eef1f0; }
.drawer-save-btn, .drawer-cancel-btn { flex: 1; border: 0; border-radius: 8px; padding: 12px; font-weight: 700; font-size: 14px; cursor: pointer; }
