          ...
          <section class="gallery-section">
            <div class="gallery-layout">
              <div class="gallery-main">
                <img :src="mainImage" :alt="accommodation?.hotelName || service.title" />
              </div>
            </div>
          </section>
